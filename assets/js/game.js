...
var startGame = function(){ 
    //reset player stats
   playerInfo.reset();
// fight enemy robots by looping over them and fighting them one at a time
...
var shop = function() {
    ...
    var shopOptionPrompt = window.prompt(
      "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter one: 'REFILL', 'UPGRADE', or 'LEAVE' to amek a choice."
    );
